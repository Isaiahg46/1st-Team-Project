...
document.addEventListener("DOMContentLoaded", function(event) {
  const startButtonBtn = document.getElementById('startButton');
  startButtonBtn.addEventListener('click', startQuiz);
});
...
function startQuiz() {
  console.log("Start Quiz function called"); // Debug
...
function loadQuestion() {
  console.log("Load Question function called"); // Debug log
